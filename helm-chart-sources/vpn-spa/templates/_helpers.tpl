...
proxies: '{{ printf "{\"/identity-server\":{\"target\":\"https://wso2am-pattern-1-am-service:8243/identity/v1/\",\"pathRewrite\":{\"^/identity-server\":\"\"},\"secure\":false,\"changeOrigin\":true,\"logLevel\":\"debug\"},\"/api/tree\":{\"target\":\"https://wso2am-pattern-1-am-service:8243/tree/v1/\",\"pathRewrite\":{\"^/api/tree\":\"\"},\"secure\":false,\"changeOrigin\":true,\"logLevel\":\"debug\"},\"/api/vpnservice\":{\"target\":\"http://52.191.30.247/\",\"pathRewrite\":{\"^/api/vpnservice\":\"\"},\"secure\":false,\"changeOrigin\":true,\"logLevel\":\"debug\"},\"/api/commands\":{\"target\":\"https://websoc.%s.sorba.ai/api/commands\",\"pathRewrite\":{\"^/api/commands\":\"\"},\"secure\":false,\"changeOrigin\":true,\"logLevel\":\"debug\"},\"/api/influx\":{\"target\":\"http://%s-influxdb:8086\",\"pathRewrite\":{\"^/api/influx\":\"\"},\"secure\":false,\"changeOrigin\":true,\"logLevel\":\"debug\"},\"/api/rtdb\":{\"target\":\"http://webdis:7379\",\"pathRewrite\":{\"^/api/rtdb\":\"\"},\"secure\":false,\"changeOrigin\":true,\"logLevel\":\"debug\"}}" .Release.Name .Release.Namespace }}'
